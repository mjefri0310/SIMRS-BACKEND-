...
import { getRegistrationById } from
"../../services/registrationService.js";
import { getRME, saveRME } from "../../services/rmeService";
import { getAll as getMedicines } from "../../services/medicineService";import { getAll as getTindakan } from "../../services/tariffService";const toast = useToast();
...
const medicine = listMedicine.value.find((m) => m._id ===
row.medicine_id);
...
const tindakan = listTindakan.value.find((m) => m._id ===
row.tariff_id);
...
<Card>
<template #title>
<div class="flex justify-content-between align-items-center"><span> Informasi Layanan </span>
</div>
</template>
<template #content>
...
<div class="col-12 mb-3">
<label>Keluhan</label>
<Textarea v-model="rme.anamnesis.complaint" class="wfull" />
</div>
<div class="col-12 mb-3">
...
<div class="col-12 mb-3">
<label>Alergi</label>
<Textarea v-model="rme.anamnesis.allergy" class="wfull" />
</div>
</div>
</TabPanel>
<!-- PEMERIKSAAN -->
...
<div class="col-4 mb-3">
<label>Nadi</label>
<InputText v-model="rme.pemeriksaan.pulse" class="wfull" />
</div>
<div class="col-4 mb-3">
...
<Textarea v-model="rme.diagnosis.diagnosis" class="wfull" />
</TabPanel>
<!-- RESEP -->
...
@click="addMedicine"
/>
<div class="flex border-1 border-300 p-3 mb-3 gap-3 flexwrap border-round">
...
:key="index"
class="flex border-1 border-300 p-3 mb-3 gap-3 flexwrap border-round"
>
<Dropdown
